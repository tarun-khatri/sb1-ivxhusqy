      ...
      <CardContent>
        ...
        >
          <Typography variant="body2" color="text.secondary">
            This account has been identified as crypto-related based on profile information and tweet content. 
            We're showing the current market data for {data.symbol}.
          </Typography>
        </Box>
      </CardContent>
    </Card>
